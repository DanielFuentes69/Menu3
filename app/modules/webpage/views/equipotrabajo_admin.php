...
$componente = $userFunc->getComponent("Gestionar Equipo");
$Face->set_name("Gestionar - Equipo Trabajo");
$Face->set_component($componente);
$Face->add_javascript("../js/team.js");
$Face->set_type("INSIDE");
$Face->add_navigation("Página Web", "equipotrabajo_admin.php");
$Face->add_navigation("Listado Equipo de Trabajo", "#");
//*******************************************************************************
//*******************************************************************************
//creacion de objetos
//*******************************************************************************
...
$rsNumRows = 0;
$Data = array();
$Data["order"] = "t.codteam";
$Data["search"][$combo_campos] = $caja_busqueda;
$TeamFacade->add_searchField($combo_campos, $caja_busqueda);
$filas = $TeamFacade->load_all($rsNumRows, $limit_numrows, $num_page, $Data);
