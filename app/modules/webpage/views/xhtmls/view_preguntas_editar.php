            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form enctype="multipart/form-data" name="frm_preguntas" id="frm_noticias" method="POST" action="moon24.php" onsubmit="javascript:return managedProccess(this);" role="form">       
                        ...
                        <input type="hidden" id="codpregunta" name="codpregunta" value="<?php echo $codPregunta;?>"/>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" id="pregunta" name="pregunta"><?php echo $Preguntas->get_pregunta(); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Respuesta</label>
                                            <textarea class="summernote" id="respuesta" name="respuesta"><?php echo $Preguntas->get_respuesta(); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
