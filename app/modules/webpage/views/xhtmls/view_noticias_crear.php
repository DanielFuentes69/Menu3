                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Seleccione una imagen  <span class="text-success">(Tamaño 830px * 476px .jpg .git .png)</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Tipo</label>
                                            <?php echo $Formulario->addObject("MenuList", "tipo", $DOM["TIPOBLOG"], "1", "class='form-control input-sm'  tabindex='3' style='cursor: pointer; width: 100%;'"); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
