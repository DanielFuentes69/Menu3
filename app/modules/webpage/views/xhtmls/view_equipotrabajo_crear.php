    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label>Cargo</label>
                    <input type="text" class="form-control input-sm" id="cargo" name="cargo" tabindex="3"/>
                </div>

                <div class="form-group">
                    <label>Url facebook</label>
                    <input type="text" class="form-control input-sm" id="facebook" name="facebook" tabindex="4"/>
                </div>

                <div class="form-group">
                    <label>Url twitter</label>
                    <input type="text" class="form-control input-sm" id="twitter" name="twitter" tabindex="5"/>
                </div>

                <div class="form-group">
                    <label>Url instagram</label>
                    <input type="text" class="form-control input-sm" id="instagram" name="instagram" tabindex="6"/>
                </div>

                <div class="form-group">
                    <label>Descripción</label>
                    <input type="text" class="form-control input-sm" id="youtube" name="youtube" tabindex="7"/>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function () {
            $("#frm_team").validate({
            ...
                    messages: {
                ...
                imagenteam: "Este campo es requerido."
                    }
            });
    });
</script>