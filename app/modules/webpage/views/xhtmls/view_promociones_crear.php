    ...
    <div class="col-lg-12">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="fileinput fileinput-new input-group col-sm-12" data-provides="fileinput">
                        ...
                        <span class="input-group-addon btn btn-success btn-file">
                            ...
                            <input type="file" accept="image/*" capture="camera" id="imgpromo" name="imgpromo" required="">
                        </span>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Titulo</label>
                    <input type="text" class="form-control input-sm" id="titulo" name="titulo" tabindex="2"/>
                </div>

                <div class="form-group">
                    <label>Nombre producto</label>
                    <input type="text" class="form-control input-sm" id="nombreproducto" name="nombreproducto" tabindex="3"/>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="porcentaje" name="porcentaje" tabindex="4"/>
                </div>
                ...
                <div class="form-group" id="fechafinprom">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control" id="fechafin" name="fechafin" tabindex="5" value="<?php echo date("d/m/Y"); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion" tabindex="6" rows="6"></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function () {
            $("#frm_promociones").validate({
            ...
                    messages: {
                ...
                imgpromo: "Este campo es requerido."
                    }
            });
    });
</script>