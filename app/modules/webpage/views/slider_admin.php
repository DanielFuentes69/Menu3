...
$componente = $userFunc->getComponent("Gestionar Slider");
$Face->set_name("Gestionar - Slider");
$Face->set_component($componente);
$Face->add_javascript("../js/slider.js");
$Face->set_type("INSIDE");
$Face->add_navigation("Página Web", "slider_admin.php");
$Face->add_navigation("Listado Imagenes", "#");
...
$rsNumRows = 0;
$Data = array();
$Data["order"] = "s.codslider";
$Data["search"][$combo_campos] = $caja_busqueda;
$SliderFacade->add_searchField($combo_campos, $caja_busqueda);
$filas = $SliderFacade->load_all($rsNumRows, $limit_numrows, $num_page, $Data);
...
$Face->floating_message($msg, 396, "Error:", "La resolución de la imagen no es 1920px * 582px.");
//*******************************************************************************
//*******************************************************************************
