...
$Face->set_name("Gestionar - Blog");
$Face->set_component($componente);
$Face->add_javascript("../js/noticias.js");
$Face->set_type("INSIDE");
$Face->add_navigation("Página Web", "noticias_admin.php");
$Face->add_navigation("Listado Blog", "#");
//*******************************************************************************
//*******************************************************************************
//creacion de objetos
//*******************************************************************************
...
$NoticiasFacade->add_searchField($combo_campos, $caja_busqueda);
