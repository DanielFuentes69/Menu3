...
$Face->set_name("Gestionar - Preguntas");
$Face->set_component($componente);
$Face->add_javascript("../js/preguntas.js");
$Face->set_type("INSIDE");
$Face->add_navigation("Página Web", "preguntas_admin.php");
$Face->add_navigation("Listado Preguntas Frecuentes", "#");
//*******************************************************************************
//*******************************************************************************
//creacion de objetos
//*******************************************************************************
...
$PreguntasFacade->add_searchField($combo_campos, $caja_busqueda);
