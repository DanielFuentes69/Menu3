...
// START: Controller private methods
    ...
    private function eliminarFuncionalidad() {
        $cod_usuario = $this->_parameters->get_parameter("codusuario", "0");
        $cod_funcionalidad = $this->_parameters->get_parameter("codfunc", "0");
        ...
        if ($FacadeFuncionalidades->deleteFuncionalidad($cod_usuario, $cod_funcionalidad) == TRUE) {
            //****************************************************************************
            //obtiene el codpadre correspondiente a la funcionalidad
            //****************************************************************************
            $cod_padre = $FacadeFuncionalidades->obtenerCodpadre($cod_funcionalidad);
            //****************************************************************************
            //****************************************************************************
            //valida la cantidad de funcionalidades hijas
            //****************************************************************************
            $cantidad_funcionalidades = $FacadeFuncionalidades->existeFunchijas($cod_padre, $cod_usuario);
            if($cantidad_funcionalidades == 0){
                $FacadeFuncionalidades->deleteFuncionalidad($cod_usuario, $cod_padre);
            }
            //****************************************************************************
            echo "EXITO";
        } else {
    ...
    private function agregarFuncionalidad() {
        $cod_usuario = $this->_parameters->get_parameter("codusuario", "0");
        $cod_funcionalidad = $this->_parameters->get_parameter("codfunc", "0");
        ...
        //****************************************************************************
        //valida si existen el codpadre asignado a las funcionalidades del usuario
        //****************************************************************************
        $existe_codpadre = $FacadeFuncionalidades->existeCodpadre($cod_padre, $cod_usuario);
        //****************************************************************************

        if ($existe_codpadre > 0) {
            if ($FacadeFuncionalidades->addFuncionalidad($cod_usuario, $cod_funcionalidad) == TRUE) {
                echo "EXITO";
            } else {
                echo "ERROR";
            }
            ...
            //****************************************************************************
            //agrega la funcionalidad padre primero antes de las hijas
            //****************************************************************************
            $FacadeFuncionalidades->addFuncionalidad($cod_usuario, $cod_padre);
            //****************************************************************************
            if ($FacadeFuncionalidades->addFuncionalidad($cod_usuario, $cod_funcionalidad) == TRUE) {
                echo "EXITO";
            } else {
