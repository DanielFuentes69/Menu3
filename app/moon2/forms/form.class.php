    ...
    switch($this->_type){
        ...
        case "CheckBox":
                foreach($this->_arrValues as $key => $value){
                        ...
                        $xhtml.="<input style=\"cursor: pointer;\" type=\"checkbox\" name=\"{$this->_fieldName}\" id=\"{$this->_id}\" value=\"{$key}\"{$check} />&nbsp;{$value}<br />\n";
                }
        break;
        case "CheckBoxHorizontal":
                foreach($this->_arrValues as $key => $value){
                        ...
                        $selected = $this->checkSelected($key);
                        if ($selected) $check = " checked=\"checked\"";
                        $xhtml.="<input style=\"cursor: pointer;\" type=\"checkbox\" name=\"{$this->_fieldName}\" id=\"{$this->_id}\" value=\"{$key}\"{$check} />&nbsp;{$value}\n";
                }
        break;
        case "Radio":
                foreach($this->_arrValues as $key => $value){
                        ...
                        $selected = $this->checkSelected($key);
                        if ($selected) $check = " checked=\"checked\"";
                        $xhtml.="<input style=\"cursor: pointer;\" type=\"radio\" name=\"{$this->_fieldName}\" id=\"{$this->_id}\" value=\"{$key}\"{$check} />&nbsp;{$value}<br />\n";
                }
        break;
         case "RadioHorizontal":
                foreach($this->_arrValues as $key => $value){
                        ...
                        $selected = $this->checkSelected($key);
                        if ($selected) $check = " checked=\"checked\"";
                        $xhtml.="<input style=\"cursor: pointer;\" type=\"radio\" name=\"{$this->_fieldName}\" id=\"{$this->_id}\" value=\"{$key}\"{$check} />&nbsp;{$value}\n";
                }
        break;
    }
    return $xhtml;
